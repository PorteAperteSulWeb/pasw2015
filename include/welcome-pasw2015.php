...
function pasw2015_supporto() { 
	echo 'ERROR 404 - TEMPO PER SCRIVERE QUESTO PANNELLO NON (ancora) TROVATO';
}

function pasw2015_plugin() {
	echo 'ERROR 404 - TEMPO PER SCRIVERE QUESTO PANNELLO NON (ancora) TROVATO';
}
...
<ul class="wp-people-group ">
	...
	<li class="wp-person">
		<a href=""><img src="http://www.gravatar.com/avatar/04d45240cb34224331ecbabe9926f698.jpg?s=60" class="gravatar"></a>
